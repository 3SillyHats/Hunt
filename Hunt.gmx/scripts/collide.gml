        ...
        if (abs(dx) <= abs(dt*other.hspeed)/2 + r + sprite_width/2 + 50 and
            ...
            if (other.hspeed == 0) {
                ...
                if ( other.x < x ) {
                    ...
                    if (discriminant > 0) {
                        var t = (-other.vspeed*(other.y-yy) - sqrt(discriminant))/sqr(other.speed)
                        if (t > 0 and t < dt) {
                            show_debug_message("vlc")
                            dt = t
                            wall = id
                            normal_x = other.x + t*other.hspeed - x
                            normal_y = other.y + t*other.vspeed - yy
                ...
                // If right of wall, check for collisions with near right corner
                    ...
                    if (discriminant > 0) {
                        ...
                        if (t > 0 and t < dt) {
                            ...
                            dt = t
                            wall = id
                            normal_x = other.x + t*other.hspeed - x - sprite_width
                            normal_y = other.y + t*other.vspeed - yy
                            var norm = sqrt(sqr(normal_x) + sqr(normal_y))
                            normal_x = normal_x/norm
                            normal_y = normal_y/norm
                ...
                // Otherwise, collide with near face
                    ...
                    var t = (yy - other.y - r*sign(other.vspeed)) / other.vspeed
                    if (t > -0.1 and t < dt) {
            ...
            // If moving horizontally
                ...
                if ( other.y < y ) {
                    ...
                    if (discriminant > 0) {
                        var t = (-other.hspeed*(other.x-xx) - sqrt(discriminant))/sqr(other.speed)
                        if (t > 0 and t < dt) {
                            show_debug_message("htc")
                            dt = t
                            wall = id
                            normal_x = other.x + t*other.hspeed - xx
                            normal_y = other.y + t*other.vspeed - y
                            var norm = sqrt(sqr(normal_x) + sqr(normal_y))
                            normal_x = normal_x/norm
                            normal_y = normal_y/norm
                            debug_colour = c_gray
                ...
                // If below wall, check for collisions with near bottom corner
                    ...
                    if (discriminant > 0) {
                        ...
                        if (t > 0 and t < dt) {
                            ...
                            wall = id
                            normal_x = other.x + t*other.hspeed - xx
                            normal_y = other.y + t*other.vspeed - y - sprite_height
                            var norm = sqrt(sqr(normal_x) + sqr(normal_y))
                            normal_x = normal_x/norm
                            normal_y = normal_y/norm
                            debug_colour = c_gray
                ...
                // Otherwise, collide with near face
                    ...
                    var t = (xx - other.x - r*sign(other.hspeed)) / other.hspeed
                    if (t > -0.1 and t < dt) {
            ...
            // If moving diagonally
                ...
                if (tx > ty) {
                    ...
                    if (sign(other.vspeed)*yx < sign(other.vspeed)*yy) {
                        var t = (-other.hspeed*(other.x-xx) - other.vspeed*(other.y-yy) - sqrt(sqr(other.speed*r) - sqr(other.hspeed*(other.y-yy) - other.vspeed*(other.x-xx))))/sqr(other.speed)
                        if (t > 0 and t < dt) {
                    ...
                    // If overshooting, check for collision with far corner
                        ...
                        if (discriminant > 0) {
                            var t = (-other.hspeed*(other.x-xx) - other.vspeed*(other.y-yy-sign(other.vspeed)*sprite_height) - sqrt(discriminant))/sqr(other.speed)
                            if (t > 0 and t < dt) {
                                show_debug_message("xfc")
                                dt = t
                                wall = id
                                normal_x = other.x + t*other.hspeed - xx
                                normal_y = other.y + t*other.vspeed - yy - sign(other.vspeed)*sprite_height
                                var norm = sqrt(sqr(normal_x) + sqr(normal_y))
                                normal_x = normal_x/norm
                                normal_y = normal_y/norm
                                debug_colour = c_gray
                ...
                // Otherwise, moving towards horizontal face
                    ...
                    // If overshooting, check for collision with far corner
                    } else if (sign(other.vspeed)*xy > sign(other.vspeed)*xx + sprite_width) {
                        var discriminant = sqr(other.speed*r) - sqr(other.hspeed*(other.y-yy) - other.vspeed*(other.x-xx-sign(other.hspeed)*sprite_width))
                        if (discriminant > 0) {
                            var t = (-other.hspeed*(other.x-xx-sign(other.hspeed)*sprite_width) - other.vspeed*(other.y-yy) - sqrt(discriminant))/sqr(other.speed)
                            if (t > 0 and t < dt) {
                                show_debug_message("yfc")
                                dt = t
                                wall = id
                                normal_x = other.x + t*other.hspeed - xx - sign(other.hspeed)*sprite_height
                                normal_y = other.y + t*other.vspeed - yy
                                var norm = sqrt(sqr(normal_x) + sqr(normal_y))
                                normal_x = normal_x/norm
                                normal_y = normal_y/norm
